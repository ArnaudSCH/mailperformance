...
class Np6 extends Module
{
	...
	private function configureCartEvents()
	{
		...
		if (Tools::isSubmit('submitMailPerfCartEvent'))
		{
			...
			foreach ($this->abandonned_cart_hooks as $name => $details)
				...
				{
					$this->message = $this->setMessage(' is empty!','error',1);
					return; //exit on error
				}
		}
	...
	private function setMessage($text, $type ,$specialCase = 0)
	{
	...
	private function CreateLinkPrestashopMailForce($send_array, $customer, & $id_mp)
	{
